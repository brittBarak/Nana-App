//package com.playground.britt.ml_fulworld;
//
...
//    private FirebaseModelInterpreter detector;
...
//    }
//
//    private void setDetector() throws FirebaseMLException {
//        FirebaseModelOptions modelOptions = new FirebaseModelOptions.Builder()
//                .setCloudModelName(HOSTED_MODEL_NAME)
//                .setLocalModelName("asset")
//                .build();
//        detector = FirebaseModelInterpreter.getInstance(modelOptions);
//    }
//
...
//        if (detector == null) {
//            failureListener.onFailure(new Exception("Custom detector wasn't loaded yet"));
//            return;
//        }
//
//        try {
...
//
//            //3.3. run model
//            detector.run(inputs, inputOutputOptions)
